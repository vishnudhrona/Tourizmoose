...
const Banner = () => {
  return (
    <div className='h-634 flex items-center justify-center gap-0 rounded-b-3xl left-0 top-0'
      style={{ backgroundImage: `url(${'/bannerbackgroundimage.svg'})` }}>
      <div className='text-center md:block hidden'>
        ...
        <div className='flex gap-4 justify-center mt-16'>
          <button className="px-4 py-2 bg-blue-500 text-white rounded-md">PICK A PACKAGE</button>
          <button className="px-4 py-2 bg-blue-500 text-white rounded-md">PLAN YOUR TRIP</button>
        </div>
      </div>
    </div>
  )
