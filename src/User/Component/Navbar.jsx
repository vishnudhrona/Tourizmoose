        ...
        <nav className={`absolute w-full z-20 top-0 start-0`}>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button
                        type="button"
                        className="bg-mobile_nav_button text-mobile_nav_button_text focus:ring-4 focus:outline-none sm:hidden focus:ring-blue-300 font-medium rounded-3xl text-xs px-3 py-2 text-center border border-mobile_nav_button_text"
                    >
                        PICK A PACKAGE
                    </button>
                    <button
                        type="button"
                        className=" bg-mobile_nav_button text-mobile_nav_button_text focus:ring-4 focus:outline-none sm:hidden focus:ring-blue-300 font-medium rounded-3xl text-xs px-3 py-2 text-center border border-blue-500"
                    >
                        PLAN YOUR TRIP
                    </button>
                    ...
                    <button
                        ...
                        type="button"
                        className="hidden sm:inline-flex items-center md:p-2 md:w-10 md:h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-transparent focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                        aria-controls="navbar-sticky"
                        aria-expanded={isMenuOpen ? 'true' : 'false'}
                    >
                        <span className="sr-only">Open main menu</span>
                        <svg
                            className="w-5 text-white hover:text-gray-400"
                            aria-hidden="true"
